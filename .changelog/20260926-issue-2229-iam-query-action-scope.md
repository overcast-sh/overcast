...
security [iam] IAM enforcement reads a Query call's Action and resource fields body-first, as handlers do, so the query string cannot stand in for them (#2229).
