...
var serviceDocsBaseMap = map[string]string{
	...
	"s3tables":        "https://docs.aws.amazon.com/AmazonS3/latest/API/API_s3TableBuckets_",
...
var statusTableOrder = []string{
	...
	"cloudformation", "rds", "elasticache", "efs", "s3tables", "appconfig", "appconfigdata",
...
var serviceCDKInfo = map[string]serviceCDK{
	...
	"s3tables":        {Modules: []string{"aws-s3tables"}},
