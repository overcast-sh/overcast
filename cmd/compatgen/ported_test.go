...
func TestCommittedRegistryPortedGroups(t *testing.T) {
	...
	want := map[string]string{
		...
		"eventbridge-buses":     "compat/model/authored/eventbridge-buses.json",
		...
		"ecr-registry":          "compat/model/authored/ecr-registry.json",
		"ecr-policies":          "compat/model/authored/ecr-policies.json",
		"ecr-tags":              "compat/model/authored/ecr-tags.json",
		"appconfig-tags":        "compat/model/authored/appconfig-tags.json",
		"appconfig-deployments": "compat/model/authored/appconfig-deployments.json",
		"backup-tags":           "compat/model/authored/backup-tags.json",
