...
// glueS3TablesBucket is the run's table bucket.
func glueS3TablesBucket(runID string) string { return tableBucketName("glue-s3tables-", runID) }

// tableBucketName is a run's table bucket name under prefix: lowercase
// letters, digits and hyphens, at most 63 of them.
func tableBucketName(prefix, runID string) string {
