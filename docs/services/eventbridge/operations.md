...
| `DescribeEventBus` | ✅ Supported | Returns bus details including Description, DeadLetterConfig, KmsKeyIdentifier and the Policy built from PutPermission grants; ResourceNotFoundException for a missing bus, by name or ARN; the default bus always exists | [docs](https://docs.aws.amazon.com/eventbridge/latest/APIReference/API_DescribeEventBus.html) |
| `ListEventBuses`   | ✅ Supported | NamePrefix, Limit (1-100, default 100) and NextToken; includes the default bus when NamePrefix admits it                                                                                                                 | [docs](https://docs.aws.amazon.com/eventbridge/latest/APIReference/API_ListEventBuses.html)   |
