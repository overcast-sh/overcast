...
| `ListShards`                    | ⚠️ Partial   | Paginates on MaxResults/NextToken/ExclusiveStartShardId, addressable by StreamName or StreamARN; returns active (open) shards only and ignores ShardFilter                                               | [docs](https://docs.aws.amazon.com/kinesis/latest/APIReference/API_ListShards.html)                    |
