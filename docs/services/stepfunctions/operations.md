...
| `RedriveExecution`    | ✅ Supported | Standard executions that FAILED, TIMED_OUT or were ABORTED within 14 days; resumes at the top-level state that did not succeed, with the input and variables it was entered with; history continues after ExecutionRedriven                                                                                   | [docs](https://docs.aws.amazon.com/step-functions/latest/apireference/API_RedriveExecution.html)    |
...
| `DescribeMapRun` | ✅ Supported | Live item and child-execution counts while the run is in progress                                   | [docs](https://docs.aws.amazon.com/step-functions/latest/apireference/API_DescribeMapRun.html) |
