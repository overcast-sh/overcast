...
func init() {
	capabilities.Default.Register(
		...
		capabilities.Capability{Service: "kinesis", Operation: "ListShards", Category: "General", Status: capabilities.StatusPartial, Notes: "Paginates on MaxResults/NextToken/ExclusiveStartShardId, addressable by StreamName or StreamARN; returns active (open) shards only and ignores ShardFilter"},
