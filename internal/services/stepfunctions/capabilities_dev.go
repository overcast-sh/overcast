...
func init() {
	capabilities.Default.Register(
		...
		capabilities.Capability{Service: "stepfunctions", Operation: "RedriveExecution", Category: "Executions", Status: capabilities.StatusSupported, Notes: "Standard executions that FAILED, TIMED_OUT or were ABORTED within 14 days; resumes at the top-level state that did not succeed, with the input and variables it was entered with; history continues after ExecutionRedriven"},
		...
		capabilities.Capability{Service: "stepfunctions", Operation: "DescribeMapRun", Category: "Map runs", Status: capabilities.StatusSupported, Notes: "Live item and child-execution counts while the run is in progress"},
